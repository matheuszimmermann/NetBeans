...
public class TimeFutebol {
    ...
    public void pesquisarTimesDisponiveis() {
        
        System.out.println("...::: Pesquisar Time :::...");
        System.out.println("------------------------------");
       
        Scanner ler = new Scanner(System.in);
        System.out.print("Nome do time a ser pesquisado: ");
        String nomeTime = ler.next();
       
        boolean timeEncontrado = false;
        ...
        if (timeEncontrado) {
            ...
            System.out.println("Time nao encontrado pois nao foi adicionado!!!!.");
        }
