...
public class TimeFutebol {
    ...
    public Time pesquisarTimesDisponiveis(String timeProcurado) {
        System.out.println("...::: Pesquisar Time :::...");
        System.out.println("----------------------------");

        Time equipAux = new Time();

        for (int i = 0; i < listaTimes.size(); i++) {
            if (listaTimes.get(i).getNome().equals(timeProcurado)) {
                equipAux = listaTimes.get(i);
            }
        }
